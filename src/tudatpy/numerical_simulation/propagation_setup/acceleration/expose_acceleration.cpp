...
.. code-block:: python
 ...
 ThrustAccelerationSettings
    ...
    m.def( "thrust_and_isp_from_custom_function",
           ...
           py::class_<tss::GravityDeformationSettings,
            std::shared_ptr<tss::GravityDeformationSettings>>(m, "GravityDeformationSettings",
                                                        R"doc(GravityDeformationSettings)doc");

    m.def("maxwell_deformation", 
        py::overload_cast< const double, const double, const double, const int, const int, const std::string, 
        const Eigen::VectorXd, const bool, const bool >( &tss::maxwellDeformationSettings ), 
    ...
    m.def("maxwell_deformation", 
        py::overload_cast< const double, const double, const double, const int, const int, const std::vector< std::string >, 
        const Eigen::VectorXd, const bool, const bool >( &tss::maxwellDeformationSettings ), 
          py::arg("maxwell_relaxation_time"),
          py::arg("global_relaxation_time"),
          py::arg("love_number"),
